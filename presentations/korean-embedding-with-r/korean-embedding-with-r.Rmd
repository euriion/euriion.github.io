...
<center>과거의 한국어 자연어처리와 텍스트마이닝에 대해서 회고하고   
현재 워드임베딩을 중심으로 바뀐 패러다임과 함께  
R에서 사용가능한 관련 패키지 대한 간단한 소개</center>
...
제품명, 지명, 인명, 기관명, 회사명, 브랜드명, 이메일, URL, 전화번호?
